...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.vm.define "ubuntu10" do |ubuntu10_config|
    ...
    ubuntu10_config.vm.box_url = "https://s3.amazonaws.com/vagrant-bx/ubuntu-10-x64.box"
  ...
  config.vm.define "centos56" do |centos56_config|
    ...
    centos56_config.vm.box_url = "https://s3.amazonaws.com/vagrant-bx/centos-5-x64.box"
